...
- Recommendation detail modal with search links across 18+ sites
...
- Job Tracker table (Excel-like: Date, Company, Position, Salary, Location, Tech, Status, Source)
...
- Web scraping engine for 18 Australian job sites
